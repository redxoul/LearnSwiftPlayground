...
로또의최고순위와최저순위.solution([44, 1, 0, 0, 31, 25], [31, 10, 45, 1, 6, 19])
로또의최고순위와최저순위.solution([0, 0, 0, 0, 0, 0], [38, 19, 20, 40, 15, 25])
로또의최고순위와최저순위.solution([45, 4, 35, 20, 3, 9], [20, 9, 3, 45, 4, 35])
